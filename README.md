...
- [bilbo](#bilbo)
  ...
  - [활용하기](#%ed%99%9c%ec%9a%a9%ed%95%98%ea%b8%b0)
    - [작업 폴더 지정](#%ec%9e%91%ec%97%85-%ed%8f%b4%eb%8d%94-%ec%a7%80%ec%a0%95)
    - [Git 저장소에서 코드 받기](#git-%ec%a0%80%ec%9e%a5%ec%86%8c%ec%97%90%ec%84%9c-%ec%bd%94%eb%93%9c-%eb%b0%9b%ea%b8%b0)
    - [인스턴스 접두어 붙이기](#%ec%9d%b8%ec%8a%a4%ed%84%b4%ec%8a%a4-%ec%a0%91%eb%91%90%ec%96%b4-%eb%b6%99%ec%9d%b4%ea%b8%b0)
...
> **팁 :** 클러스터 생성후, 바로 노트북을 띄우고 싶은 경우 `create` 에 `-n` 옵션을 주면 된다. (단, 클라우드 노트북을 사용할 때만 가능)
>
...
> **참고 :** `-p` 를 반복적으로 사용하면, 여러 매개 변수를 줄 수 있다.
